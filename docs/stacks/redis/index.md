...
Redis can be configured with the following [environment variables](https://github.com/anaxexp/redis#environment-variables)
...
* Version freeze https://github.com/anaxexp/redis#versions
