...
* Nginx can be configured with the following [environment variables](https://github.com/anaxexp/wordpress-nginx#environment-variables)
* Default Nginx [virtual host config](https://github.com/anaxexp/wordpress-nginx/blob/master/templates/vhost.conf.tpl)
